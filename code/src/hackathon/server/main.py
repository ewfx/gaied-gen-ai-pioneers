    ...
    if typ == 'OK':
        for num in data[0].split():
            ...
            if typ == 'OK':
                ...
                # forward_email.delay(email_message.as_string(), smtp_server, smpt_port, email_id, email_password, fwd_email, cc.append("yarndev.Wells Fargo@gmail.com"), bcc, sentiment) 
